using MileXamlControlsDemoNetFramework.Backdrop;
using MileXamlControlsDemoNetFramework.UI.Backdrop;
using System;
...
namespace MileXamlControlsDemoNetFramework
{
    ...
    {
        private ObservableCollection<TreeViewItemModel> TreeViewDataList = new ObservableCollection<TreeViewItemModel> {
            new TreeViewItemModel {
                Name = "TreeView Root Node 1", IsSelected = true,
                ChildrenNode = [
                    new TreeViewItemModel { Name = "TreeView child Node 1", IsSelected = false },
                    new TreeViewItemModel { Name = "TreeView child Node 2", IsSelected = false },
                    new TreeViewItemModel { Name = "TreeView child Node 3", IsSelected = false }
                ]
            },
            new TreeViewItemModel {
                Name = "TreeView Root Node 2", IsSelected = false,
                ChildrenNode = [
                    new TreeViewItemModel { Name = "TreeView child Node 4", IsSelected = false },
                    new TreeViewItemModel { Name = "TreeView child Node 5", IsSelected = false },
                ]
            }
        };
