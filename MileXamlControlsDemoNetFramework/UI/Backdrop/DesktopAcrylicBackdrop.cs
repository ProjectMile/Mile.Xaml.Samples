...
using MileXamlControlsDemoNetFramework.WindowsAPI.PInvoke.Comctl32;
using MileXamlControlsDemoNetFramework.WindowsAPI.PInvoke.Kernel32;
...
namespace MileXamlControlsDemoNetFramework.UI.Backdrop
{
    public class DesktopAcrylicBackdrop : SystemBackdrop
    {
        ...
        private CompositionBrush BuildDesktopAcrylicEffectBrush(Compositor compositor, Color tintColor, float tintOpacity, float luminosityOpacity)
        {
            ...
            noiseBrush.Surface = LoadedImageSurface.StartLoadFromUri(new Uri(Path.Combine(AppContext.BaseDirectory, @"Resources\NoiseAsset_256x256_PNG.png")));
